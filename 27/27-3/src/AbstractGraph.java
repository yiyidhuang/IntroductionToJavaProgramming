...
public abstract class AbstractGraph<V> implements Graph<V> {
	...
	/** Construct a graph from eges and vertices stored in List */
	...
	/** Return the neighbors of vertex with the specifed index */
	...
	/** To be dicussed in Section 27.7 */
