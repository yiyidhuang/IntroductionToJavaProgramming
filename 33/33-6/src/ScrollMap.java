...
public class ScrollMap extends JApplet{
	...
	public ScrollMap() {
		...
		p.add(jcboMap);
		p.setBorder(new TitleBorder("Select a map to display"));
		...
		jspMap.setCorner(ScrollPaneConstants.UPPER_RIGHT_CORNER, new CornerPanel(JScrollPane.UPPER_RIGHT_CORNER));	
		jspMap.setCorner(JScrollPane.LOWER_RIGHT_CORNER, new CornerPanel(JScrollPane.LOWER_LEFT_CORNER));
...
class CornerPane extends JPanel {
	// Line location
