...
public class BorderDemo extends JApplet {
	...
	private JRadioButton 
			jrbAboveBottom, jrbBottom, 
			jrbBelowBottom, jrbAboveTop, 
			jrbTop, jrbBelowTop,
	...
	/** Constructor */
	public BorderDemo() {
		// Create JLabel instance and set colors
		...
		// Create panel jpTitledOptions to hold jpPosition and 
		// jpJustification
		...
		// Create Panel jpAllChoices to place  jpTilte and jpBorderStyle
