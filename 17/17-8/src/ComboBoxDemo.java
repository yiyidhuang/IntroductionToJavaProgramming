...
public class ComboBoxDemo extends JFrame {
	...
	public ComboBoxDemo() {
		...
		flagDescription[0] = "The Mapel Leaf flag \n\n" +
				"The Canadian National Flag was adopted by the Canadian " +
				"Parilianment on October 22, 1964 and was proclaimed into law " +
				"by Her Majesty Queen Elizbeth II (the Queen of Canada) on " +
				...
				"maple leaf centerd in the white squre.";
		...
		// Add combo box and description panel to this list
