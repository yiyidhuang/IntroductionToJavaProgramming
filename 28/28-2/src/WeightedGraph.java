...
public class WeightedGraph<V> extends AbstractGraph<V> {
	...
	/** Construct a WeightedGraph from edgs and vertices in List */
	...
	public MST getMinimumSpanningTree(int startingIndex) {
		...
		// T initially contains the tartingVertex;
		T.add(startingIndex);
		...
		while (T.size() < numberOfVertices) {
			...
			T.add(v); // Add a new vetex to the tree
	...
	/** MST is an inner clas in WeightedGraph */
	public class MST extends Tree {
		private int totalWeight; // Total weight of al edges in the tree
	...
	public class ShortestPathTree extends Tree {
		...
		/** Construct a path */
		public ShortestPathTree(int source, 
				int[] parent, List<Integer> searchOrder, int[] costs) {
